...
const Internship = () => {
  ...
  return (
    <>
      ...
      <div>
        <Typography.Title>Internships</Typography.Title>
        <Space size={"large"} direction="vertical">
          {[
            "Software Development Internship",
            "Networking and Cyber Security Internship",
            " Web Applications Development using React , Redux ,Next JS and Hooks Internship  ",
