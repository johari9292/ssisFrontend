...
const Workshop = () => {
  ...
  return (
    <>
      ...
      <div>
        <Typography.Title>Workshops</Typography.Title>
        <Space size={"large"} direction="vertical">
          {[
            "Software Development Workshop",
            "Networking and Cyber Security Workshop",
            " Web Applications Development using React , Redux ,Next JS and Hooks Workshop  ",
