...
const Trainings = () => {
  ...
  return (
    <>
      ...
      <div>
        <Typography.Title>Trainings</Typography.Title>
        <Space size={"large"} direction="vertical">
          {[
            "Software Development Training",
            "Networking and Cyber Security Training",
            " Web Applications Development using React , Redux ,Next JS and Hooks Training  ",
